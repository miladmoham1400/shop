...
$(function () {
  ...
  function setup() {
    ...
    if ($('body').hasClass('rtl')) {
      $('[data-layouts="rtl"]').attr('checked', 'checked')
    }
    if ($('body').hasClass('dark')) {
      $('[data-layouts="dark"]').attr('checked', 'checked')
    }
  ...
  $demoSettings.append(
	...
	+ '<input type="checkbox" data-layouts="fixed" id="layout_fixed">'
    ...
    + '</label>'
	+ '<label class="switch switch-border switch-danger">'
	+ '<input type="checkbox" data-layouts="layouts-boxed" id="layout_boxed">'
	+ '<span class="switch-indicator"></span>'
	+ '<span class="switch-description"></span>'
	+ '</label>'
	+ '</div>'
    ...
    + '</label>'
	+ '<label class="switch switch-border switch-danger">'
	+ '<input type="checkbox" data-layouts="sidebar-collapse" id="toggle_sidebar">'
	+ '<span class="switch-indicator"></span>'
	+ '<span class="switch-description"></span>'
	+ '</label>'
	+ '</div>'
    ...
    + '</label>'
	+ '<label class="switch switch-border switch-danger">'
	+ '<input type="checkbox" data-layouts="rtl" id="rtl">'
	+ '<span class="switch-indicator"></span>'
	+ '<span class="switch-description"></span>'
	+ '</label>'
	+ '</div>'
    ...
    + '</label>'
	+ '<label class="switch switch-border switch-danger">'
	+ '<input type="checkbox" data-layouts="dark" id="dark">'
	+ '<span class="switch-indicator"></span>'
	+ '<span class="switch-description"></span>'
	+ '</label>'
	+ '</div>'

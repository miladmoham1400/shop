...
$('#list-view').on("click", function() {
	...
	$('#content .product-layouts').attr('class', 'product-layouts product-list col-xs-12');
...
$(document).on('click', '#grid-view', function(e){
	$('#content .product-layouts').attr('class', 'product-layouts product-grid col-lg-5ths col-md-5ths col-sm-3 col-xs-12');
